...
define('DB_PASSWORD', '');
define('DB_DATABASE', 'demo_topgirl');
// define('DB_USERNAME', 'sozoone_live');
// define('DB_PASSWORD', 'TY_(y!7k)G-E');
// define('DB_DATABASE', 'sozoone_live');
define('DB_PORT', '3306');
define('DB_PREFIX', 'topgirl_');

define('ADVANCE_PASSWORD', false);
define('ADMIN_FOLDER', '19052020');
