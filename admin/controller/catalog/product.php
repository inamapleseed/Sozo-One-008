		...
		foreach ($results as $result) {
			...
			foreach ($product_specials  as $product_special) {
				...
				if (($product_special['date_start'] == '0000-00-00' || strtotime($product_special['date_start']) <= strtotime(date('Y-m-d'))) && ($product_special['date_end'] == '0000-00-00' || strtotime($product_special['date_end']) >= strtotime(date('Y-m-d')))) {
					...
					$special2 = $product_special['isbn'];
					$special3 = $product_special['mpn'];
	...
	protected function getForm() {
			...
			if (isset($product_option['product_option_value'])) {
				foreach ($product_option['product_option_value'] as $product_option_value) {
					...
					$product_option_value_data[] = array(
						...
						// 'isbn'                   => $product_option_value['isbn'],
						// 'mpn'                   => $product_option_value['mpn'],
		...
		foreach ($product_discounts as $product_discount) {
			$data['product_discounts'][] = array(
				...
				'isbn'             => $product_discount['isbn'],
				'mpn'             => $product_discount['mpn'],
		...
		foreach ($product_specials as $product_special) {
			$data['product_specials'][] = array(
				...
				'isbn'              => $product_special['isbn'],
				'mpn'             	=> $product_special['mpn'],
