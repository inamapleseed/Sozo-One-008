...
<div id="content">
					...
					<div class="tab-content">
							...
							<div class="tab-content">
								<?php foreach ($languages as $language) { ?>
									...
									<!-- 	<div class="form-group">
											<label class="col-sm-2 control-label" for="input-upc">Description Text</label>
											<div class="col-sm-10">
												<input type="text" name="upc" value="Description:" placeholder="Description Title" id="input-upc" class="form-control" />
											</div>
										</div> -->
						...
						<div class="tab-pane" id="tab-data">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="price" value="<?= $price; ?>" placeholder="<?= $entry_price; ?> 3" id="input-price" class="form-control" />
								</div>
							</div>
							<div class="form-group ">
								<label class="col-sm-2 control-label" for="input-isbn">Price 2</label>
								<div class="col-sm-10">
									<input type="text" name="isbn" value="<?= $isbn; ?>" placeholder="Price 2" id="input-isbn" class="form-control" />
								</div>
							</div>
							<div class="form-group ">
								<label class="col-sm-2 control-label" for="input-mpn">Price 3</label>
								<div class="col-sm-10">
									<input type="text" name="mpn" value="<?= $mpn; ?>" placeholder="Price 1" id="input-mpn" class="form-control" />
								</div>
							</div>
							<div class="form-group">
									...
									<tbody>
										...
										<?php foreach ($product_specials as $product_special) { ?>
											<tr id="special-row<?= $special_row; ?>">
												...
												<td class="text-right">
													<div class="input-group">
														<input type="number" id="input1" value="" placeholder="<?= $entry_percentage; ?>" class="form-control percent-input percent-input<?= $special_row; ?>" data-calc="product_special[<?= $special_row; ?>][price]" />

														<input type="number" id="input2" value="" placeholder="<?= $entry_percentage; ?>" class="form-control percent-input2 percent-input2<?= $special_row; ?>" data-calc="product_special[<?= $special_row; ?>][isbn]" />

														<input type="number" id="input3" value="" placeholder="<?= $entry_percentage; ?>" class="form-control percent-input3 percent-input3<?= $special_row; ?>" data-calc="product_special[<?= $special_row; ?>][mpn]" />
												...
												<td class="text-right">
													<input type="text" name="product_special[<?= $special_row; ?>][price]" value="<?= $product_special['price']; ?>" placeholder="<?= $entry_price; ?>" class="form-control price-special" data-calc="percent-input<?= $special_row; ?>" />

													<input type="text" name="product_special[<?= $special_row; ?>][isbn]" value="<?= $product_special['isbn']; ?>" placeholder="<?= $entry_price; ?>" class="form-control price-special" data-calc="percent-input2<?= $special_row; ?>" />

													<input type="text" name="product_special[<?= $special_row; ?>][mpn]" value="<?= $product_special['mpn']; ?>" placeholder="<?= $entry_price; ?>" class="form-control price-special" data-calc="percent-input3<?= $special_row; ?>" />
												</td>
	...
	<script type="text/javascript">
		...
		function addSpecial() {
			...
			html += '		<input type="number" value="" placeholder="<?= $entry_percentage; ?>" class="form-control percent-input2 percent-input2' + special_row + '" data-calc="product_special[' + special_row + '][isbn]" />';
			html += '		<input type="number" value="" placeholder="<?= $entry_percentage; ?>" class="form-control percent-input3 percent-input3' + special_row + '" data-calc="product_special[' + special_row + '][mpn]" />';
			...
			html += '  </td>';
			html += '  <td class="text-right">';
			html += '  <input type="text" name="product_special[' + special_row + '][price]" value="" placeholder="<?= $entry_price; ?>" class="form-control price-special" data-calc="percent-input' + special_row + '" />';
			html += '  <input type="text" name="product_special[' + special_row + '][isbn]" value="" placeholder="<?= $entry_price; ?>" class="form-control price-special" data-calc="percent-input2' + special_row + '" />';
			html += '  <input type="text" name="product_special[' + special_row + '][mpn]" value="" placeholder="<?= $entry_price; ?>" class="form-control price-special" data-calc="percent-input3' + special_row + '" />';
			html += '  </td>';
	...
	function getPercentage2(old_price2, new_price2) {
		if(old_price2 && new_price2) {
			var decreaseValue2 = Number(old_price2) - Number(new_price2);
			return (Math.abs(decreaseValue2 / old_price2) * 100).toFixed(2);
		}
	}
	function getPercentage3(old_price3, new_price3) {
		if(old_price3 && new_price3) {
			var decreaseValue3 = Number(old_price3) - Number(new_price3);
			return (Math.abs(decreaseValue3 / old_price3) * 100).toFixed(2);
		}
	}
	...
	$(document).on('keyup', '.percent-input2', function(){
		var new_price2 = getPrice($('#input-isbn').val(), $(this).val());
		$('input[name="' + $(this).data('calc') + '"]').val(new_price2);
	});

	$(document).on('keyup', '.percent-input3', function(){
		var new_price3 = getPrice($('#input-mpn').val(), $(this).val());
		$('input[name="' + $(this).data('calc') + '"]').val(new_price3);
	});
	...
	function calcPercentage2(price_field, old_price2, new_price2) {
		var percent2 = getPercentage2(old_price2, new_price2);
		//console.log(percent);
		$('.' + price_field.data('calc')).val(percent2);
	}
	
	function calcPercentage3(price_field, old_price3, new_price3) {
		var percent3 = getPercentage3(old_price3, new_price3);
		//console.log(percent);
		$('.' + price_field.data('calc')).val(percent3);
	}

	$(document).on('keyup', '.price-special', function(){
		calcPercentage($(this), $('#input-price').val(), $(this).val());
		calcPercentage2($(this), $('#input-isbn').val(), $(this).val());
		calcPercentage3($(this), $('#input-mpn').val(), $(this).val());
	});
