            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center cart-quantity">
                    ...
                    <div class="input-group this-div" id="cart-item-<?= $product['cart_id']; ?>" >
                      ...
                      <input type="text" name="quantity[<?= $product['cart_id']; ?>]" class="form-control input-number integer text-center update-cart no-custom this-input" value="<?= $product['quantity']; ?>" onfocus="rememberQuantity('<?= $product['quantity']; ?>');" onblur="refreshCart(this);">
