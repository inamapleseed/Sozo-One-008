<?= $header; ?>
<!--<div style="background-image: url(image/catalog/slicing/01_Topgirl/bg-min.jpg); background-size: cover; background-repeat: no-repeat; background-position: center;"> -->
<div>
