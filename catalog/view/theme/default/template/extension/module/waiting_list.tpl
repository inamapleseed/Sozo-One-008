<div id="waiting_list">
    <div class="waiting_list_container">
        ...
        <div class="flex-group flex-wrap flex-just-cont-center">
            <input name="email" placeholder="<?= $entry_email; ?> Address" value="<?= $email; ?>" class="pd-5 mg-t10 mg-b10" />
            <button id="waiting_list_submit" type="button" class="btn that-button mg-b10" ><?= $button_submit; ?></button>
        </div>
    </div>
